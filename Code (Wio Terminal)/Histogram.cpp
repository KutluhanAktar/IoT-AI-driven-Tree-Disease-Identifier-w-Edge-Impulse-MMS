...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void TFT_Histogram::shrinkShowHistogram(uint16_t x,uint16_t y,uint8_t shrinkMultiple, uint32_t textColour,uint32_t textBackgroundColour,uint32_t background)
{ 
  Histogram_width=y+2;
  tft_Histogram->fillScreen(background);                   //Fill the screen with white
  tft_Histogram->setRotation(2);                         //The origin is in the lower left corner facing the usb port

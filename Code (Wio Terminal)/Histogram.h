...
class TFT_Histogram 
{
  ...
  public:
        ...
        void shrinkShowHistogram(uint16_t x, uint16_t y, uint8_t shrinkMultiple, uint32_t textColour,uint32_t textBackgroundColour,uint32_t background);                                     //The function is show histogram more little
